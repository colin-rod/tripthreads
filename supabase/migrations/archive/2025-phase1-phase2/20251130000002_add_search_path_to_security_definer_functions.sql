...
-- Description: Fix 3F000 (INVALID SCHEMA NAME) errors by setting explicit search_path
-- Author: Claude Code
-- Date: 2025-11-30
-- ============================================================================

-- PostgreSQL requires SECURITY DEFINER functions to have an explicit search_path
-- for security reasons. Without it, they can fail with 3F000 errors.

-- ============================================================================
-- Update create_trip_owner_participant trigger function
-- ============================================================================
...
-- - Fixes both trip creation errors and RLS policy execution
-- ============================================================================
