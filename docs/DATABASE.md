...
interface AccessRequest {
  id: string // UUID
  trip_id: string // FK → trips.id
  requester_id: string // FK → users.id (user requesting access)
...
users
  ...
  ├── chat_messages (as author)
  ├── message_reactions (as reactor)
  ├── media_files (as uploader) [Phase 3]
...
3. ✅ `20250129000007_create_trip_invites.sql` - Invitation system
4. ✅ `20250131000001_create_access_requests.sql` - Access request system

### Phase 2: Itinerary & Ledger

5. ✅ `20250129000002_add_date_scoped_rls_and_tables.sql` - Expenses and itinerary
6. ✅ `20250130000001_add_partial_joiner_dates.sql` - Partial joiner date visibility
7. ✅ `20250130000002_update_rls_for_partial_joiners.sql` - RLS for partial joiners
8. ✅ `20250130000003_expense_proration_for_partial_joiners.sql` - Expense proration
9. ✅ `20250129000003_create_settlements_table.sql` - Settlement tracking
10. ✅ `20250207000001_enhance_itinerary_items.sql` - Enhanced itinerary fields
11. ✅ `20250208000001_add_fx_rates_and_base_currency.sql` - Multi-currency support
12. ✅ `20250206000001_create_chat_messages.sql` - Trip chat
13. ✅ `20250208000002_create_message_reactions.sql` - Message reactions

### RLS Fixes

- ✅ `20250129000003_fix_rls_infinite_recursion.sql`
- ✅ `20250129000004_fix_can_user_see_item_recursion.sql`
- ✅ `20250129000005_fix_remaining_rls_recursion.sql`
