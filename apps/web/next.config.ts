        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.openai.com https://vitals.vercel-insights.com https://api.stripe.com",
              "img-src 'self' data: https://*.supabase.co https://lh3.googleusercontent.com",
              "style-src 'self' 'unsafe-inline'",
              "font-src 'self' data:",
              "frame-src 'self' https://vercel.live https://checkout.stripe.com https://js.stripe.com",
