    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        <p className="text-muted-foreground mb-6 max-w-md">
          {missingEnvError.message}. Add the required environment variables to enable settings.
        </p>
      </div>
    )
  }
  ...
  try {
    ...
    const errorMessage =
      error instanceof Error && error.message.startsWith('Missing Supabase environment variables')
        ? `${getMissingSupabaseEnvError().message}. Add the required environment variables to enable settings.`
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        <h2 className="text-2xl font-semibold mb-2">Unable to load settings</h2>
